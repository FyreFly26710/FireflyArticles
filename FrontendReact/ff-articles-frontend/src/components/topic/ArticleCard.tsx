...
import styles from '@/styles/articlesgroup.module.css';
...
const ArticleCard = (props: Props) => {
    ...
    return (
        <div className={styles.articlecontainer}>
            <Card className={`${styles.articlecard} ${styles.articleheaderCard}`}>
                ...
                {!isEditing && <TagList tags={article.tags} />}
            ...
            <Card className={`${styles.articlecard} ${styles.articlecontentCard}`}>
                {isEditing ? (
                    <MdEditor
                        value={editedContent}

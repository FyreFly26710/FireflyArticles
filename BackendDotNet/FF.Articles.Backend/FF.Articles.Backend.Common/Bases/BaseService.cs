    ...
    where TContext : DbContext
{
    ...
    public virtual async Task<TEntity?> GetByIdAsync(int id, bool asTracking = false) => await _repository.GetByIdAsync(id, asTracking);
    ...
    public virtual async Task<List<TEntity>> GetAllAsync(bool asTracking = false) => await _repository.GetAllAsync(asTracking);
    public virtual async Task<List<TEntity>> GetByIdsAsync(List<int> ids, bool asTracking = false) => await _repository.GetByIdsAsync(ids, asTracking);

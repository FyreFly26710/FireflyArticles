    ...
    where TContext : DbContext
{
    ...
    public virtual async Task<TEntity?> GetByIdAsTrackingAsync(int id) => await _repository.GetByIdAsTrackingAsync(id);
    ...
    public virtual async Task<bool> HardDeleteAsync(int id) => await _repository.HardDeleteAsync(id);
    ...
    public virtual async Task<List<int>> UpdateBatchAsync(List<TEntity> entities) => await _repository.UpdateBatchAsync(entities);

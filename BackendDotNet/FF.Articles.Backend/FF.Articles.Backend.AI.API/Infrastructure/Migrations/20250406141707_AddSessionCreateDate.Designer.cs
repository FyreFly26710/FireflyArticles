...
namespace FF.Articles.Backend.AI.API.Infrastructure.Migrations
{
    ...
    [Migration("20250406141707_AddSessionCreateDate")]
    partial class AddSessionCreateDate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FF.Articles.Backend.AI.API.Models.Entities.Session", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTime(2025, 4, 6, 14, 17, 6, 979, DateTimeKind.Utc).AddTicks(5090));

...
public static class ContentsDbSeedData
{
    ...
    public static List<Article> GetArticles()
    {
        return new List<Article>
        {
            ...
            new Article { Id = 3, Title = "Java Control Structures", Content = "Control structures content", Abstract = "Control structures", ArticleType = ArticleTypes.Article, ParentArticleId = null, UserId = 100, TopicId = 1, SortNumber = 3, IsHidden = 0 },
            ...
            new Article { Id = 5, Title = "Java Multithreading", Content = "Multithreading content", Abstract = "Multithreading", ArticleType = ArticleTypes.Article, ParentArticleId = null, UserId = 1, TopicId = 200, SortNumber = 2, IsHidden = 0 },
            ...
            new Article { Id = 8, Title = "C# Variables and Types", Content = "Variables content", Abstract = "Variables", ArticleType = ArticleTypes.SubArticle, ParentArticleId = 7, UserId = 1, TopicId = 300, SortNumber = 2, IsHidden = 0 },
            new Article { Id = 9, Title = "C# Control Flow", Content = "Control flow content", Abstract = "Control flow", ArticleType = ArticleTypes.Article, ParentArticleId = null, UserId = 1, TopicId = 300, SortNumber = 3, IsHidden = 0 },

            // C# Advanced Topic Articles
            new Article { Id = 10, Title = "C# Advanced Features", Content = "Advanced features content", Abstract = "Advanced features", ArticleType = ArticleTypes.Article, ParentArticleId = null, UserId = 1, TopicId = 400, SortNumber = 1, IsHidden = 0 },
            new Article { Id = 11, Title = "C# LINQ", Content = "LINQ content", Abstract = "LINQ", ArticleType = ArticleTypes.Article, ParentArticleId = null, UserId = 1, TopicId = 400, SortNumber = 2, IsHidden = 0 },
            new Article { Id = 12, Title = "C# Async/Await", Content = "Async/Await content", Abstract = "Async/Await", ArticleType = ArticleTypes.SubArticle, ParentArticleId = 10, UserId = 1, TopicId = 400, SortNumber = 3, IsHidden = 0 },

            // Cross-Platform Development Topic Articles
            new Article { Id = 13, Title = "Cross-Platform Basics", Content = "Cross-platform basics content", Abstract = "Cross-platform basics", ArticleType = ArticleTypes.Article, ParentArticleId = null, UserId = 1, TopicId = 500, SortNumber = 1, IsHidden = 0 },
            new Article { Id = 14, Title = "Xamarin Development", Content = "Xamarin content", Abstract = "Xamarin", ArticleType = ArticleTypes.Article, ParentArticleId = null, UserId = 1, TopicId = 500, SortNumber = 2, IsHidden = 0 },
            new Article { Id = 15, Title = ".NET MAUI", Content = "MAUI content", Abstract = "MAUI", ArticleType = ArticleTypes.SubArticle, ParentArticleId = 13, UserId = 1, TopicId = 500, SortNumber = 3, IsHidden = 0 }
        };
    }
